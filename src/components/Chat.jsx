  ...
  return (
    <div className="userChat-container">
      <div className="userChat-header">
        <a href="#">
          <img src="public/images/userChat.png" className="userChat-img" alt="" />
        </a>
        <h3 className="userChat-name">Travis Barker</h3>
        <p className="userChat-status">Online</p>
        <a href="#">
          <img
            src="public/images/video call.png"
            className="videoChat-icon"
            alt=""
          />
        </a>
        <a href="#">
          <img src="public/images/userInfo.png" className="userInfo-icon" alt="" />
        </a>
      </div>

      <div className="chat-area">
        <a href="#">
          <img src="public/images/chat img.png" className="msg-img" />
        </a>
        <a href="#" className="msg-link">
          <p>https://dribbble.com/shots/17742253-ui-kit-designjam</p>
        </a>
        ...
        <span className="msg-data thirdMsg">
          ...
          <img src="public/images/chat1/tick.png" />
        </span>
        ...
        <div className="chat-input-area">
          <a href="#">
            <img src="public/images/pin icon.png" className="pin-icon" />
          </a>
